...
namespace ChartboostSDK
{
	public class CBManifest
	{
		...
		public static bool CheckAndFixManifest()
		{
			...
			{
				Debug.LogError(string.Format("{0} activity is missing from your android manifest. Add \"<meta-data android:name=\"unityplayer.ForwardNativeEventsToDalvik\" android:value=\"false\" />\" to your activity tag so that Chartboost can forward touch events to the advertisements.", unityNativeActivityName));
				return false;
			}
